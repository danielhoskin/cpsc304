...
public class MainFrame {
    ...
    public MainFrame(User newUser) {
        initialiseComponents(newUser);
    }
    ...
    private static void initialiseComponents(User newUser){
        ...
        diagnosis.addActionListener(new DiagnosisListener());
    ...
    private static class DiagnosisListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            Object diagnosisID[][] = {
                    ...
                    { "5849302","5258932", "5258932" },
                    { "Michael Bay","5258932", "5258932"},
                    { "Joseph Levit","5258932", "5258932"},
            };
